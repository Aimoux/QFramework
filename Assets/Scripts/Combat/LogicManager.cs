...
public static class LogicManager 
{
    ...
    /// pve�?:关卡战斗入口,需要传�? LevelData , List<Hero> �? isbot（是否为电脑�?
    ...
    //        //初�?�化场景包括刷�?
    //        CombatConfigData data = DataNewManager.Instance.CombatConfigs.Value[level.LevelID][roundId];//拿战斗数�?
...
//                role.Init();
//            }
//            CombatConfigData data = DataNewManager.Instance.CombatConfigs.Value[-2][1];//拿战斗数�?
//            //初�?�化场景
