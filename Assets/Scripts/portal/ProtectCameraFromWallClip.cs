...
namespace UnityStandardAssets.Cameras
{
    public class ProtectCameraFromWallClip : MonoBehaviour
    {
        ...
        private void LateUpdate()
        {
            ...
            var cols = Physics.OverlapSphere(m_Ray.origin, sphereCastRadius,protectMask);
            ...
            {
                //ɸѡ��������isTrigger����PlayerTag��null rigid
                if ((!cols[i].isTrigger) &&
            ...
            {//ǰ��һС��
                ...
                m_Hits = Physics.RaycastAll(m_Ray, m_OriginalDist - sphereCastRadius, protectMask);
            }
            else
            {
                // if there was no collision do a sphere cast to see if there were any other collisions
                //SphereCastAll�������׸�������ray��origin���ɣ�������return to normal
                m_Hits = Physics.SphereCastAll(m_Ray, sphereCastRadius, m_OriginalDist + sphereCastRadius, protectMask);
            }
            ...
            for (int i = 0; i < m_Hits.Length; i++)
            {
                      ...
                      m_Hits[i].collider.attachedRigidbody.CompareTag(dontClipTag)))
                {
                    ...
                    hitSomething = true;
                   /// Debug.Log("cameraPos protected from: "+m_Hits[i].collider.name);
                }
            }
